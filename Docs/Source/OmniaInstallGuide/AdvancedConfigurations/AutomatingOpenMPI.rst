...
* A local repository has been set up by listing ``{"name": "amd_benchmarks"},`` in ``input/software_config.json`` and running ``local_repo.yml``. For more information, `click here. <../RHEL_new/CreateLocalRepo/index.html>`_
...
* A local OpenMPI repository has been created. For more information, `click here <../RHEL_new/CreateLocalRepo/localrepos.html>`_.
